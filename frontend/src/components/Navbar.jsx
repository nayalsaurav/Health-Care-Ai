...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      ...
      {/* <!-- Dropdown menu --> */}
      <div classNamename="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
